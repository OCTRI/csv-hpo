...
public class LabSummary {
	 ...
	 * @param min_normal a null value means that a min value for normal finding
	 *                   could not be established
	 * @param max_normal a null value means that a max value for normal finding
	 *                   could not be established
	 */
	public void put(String unit, int count, Double mean, Double min_normal, Double max_normal) {
	...
	public String getPrimaryUnit() {
		return this.countByUnit.entrySet().stream().sorted(Map.Entry.comparingByValue((a, b) -> b - a))
